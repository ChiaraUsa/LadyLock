...
async function establecerNombre() {
    $.ajax({
        ...
        error: function (xhr, status) {
            alert('ha sucedido un problema al establecer nombre');
        },
...
function newChatID(){
    $.ajax({
        url: "/api/chat/newChatID?userEmail="+localStorage.email,
        type: 'GET',
        headers: {
            "Authorization": "Bearer " + Cookies.get('token')
        },
...
function onConnected(frame) {
    ...
    stompClient.send("/app/chat.addUser?userEmail="+localStorage.email,
        {},
